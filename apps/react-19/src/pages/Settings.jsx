    ...
    <div className="settings">
      ...
      <div className="settings-group">
        ...
        <p>
          ...
          the <code>use()</code> hook can be called inside conditionals,
          loops, and after early returns.
        </p>
      </div>
      ...
      <div className="settings-group">
        ...
        <ul style={{ paddingLeft: '20px', fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
          <li><strong>useActionState</strong> — form actions with built-in pending state</li>
          <li><strong>useFormStatus</strong> — read parent form's pending state</li>
          <li><strong>useOptimistic</strong> — instant optimistic UI updates</li>
          <li><strong>use()</strong> — read context & promises, even conditionally</li>
          <li><strong>ref as prop</strong> — no more forwardRef needed</li>
