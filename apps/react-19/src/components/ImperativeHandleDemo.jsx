 ...
 *
 * In React 19, FancyInput accepts ref as a regular prop — no
  ...
  return (
    <div className="batching-demo">
      ...
      <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginBottom: 12 }}>
        ...
        exactly what the parent can do.{' '}
        <strong>🆕 No forwardRef needed in React 19!</strong>
      </p>

      {/* 🆕 React 19: FancyInput takes ref as a regular prop */}
