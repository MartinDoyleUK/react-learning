 ...
 *
 * This component is loaded via React.lazy() in App.jsx:
    ...
    <div className="settings">
      ...
      <div className="settings-group">
        ...
        <ul style={{ paddingLeft: '20px', fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
          <li>New JSX Transform (no <code>import React</code> needed)</li>
          <li>Event delegation on root container (not document)</li>
          <li>Async useEffect cleanup timing</li>
          <li>No new developer-facing APIs — a "stepping stone" release</li>
        </ul>
      </div>
    </div>
  );
