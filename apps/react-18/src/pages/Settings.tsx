  ...
  return (
    <div className="settings">
      ...
      <div className="settings-group">
        ...
        >
          <li>
            <strong>createRoot</strong> — new concurrent root API (replaces
            ReactDOM.render)
          </li>
          <li>
            <strong>Automatic Batching</strong> — setState batched everywhere,
            not just event handlers
          </li>
          <li>
            <strong>useTransition</strong> — mark updates as non-urgent for
            responsive UIs
          </li>
          <li>
            <strong>useDeferredValue</strong> — defer expensive re-renders
          </li>
          <li>
            <strong>useId</strong> — generate stable unique IDs for accessibility
          </li>
          <li>
            <strong>useSyncExternalStore</strong> — safe subscription to external
            stores
          </li>
          <li>
            <strong>Strict Mode</strong> — double-fires effects in dev to catch
            cleanup bugs
          </li>
          <li>
            <strong>flushSync</strong> — opt out of batching for immediate DOM
            updates
          </li>
          <li>
            <strong>useInsertionEffect</strong> — inject styles before DOM mutations
            (CSS-in-JS)
          </li>
        </ul>
      </div>
